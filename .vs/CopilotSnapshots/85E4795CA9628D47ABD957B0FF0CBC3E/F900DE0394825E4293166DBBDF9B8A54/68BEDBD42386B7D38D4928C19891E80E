...
namespace przychodnia.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> OdzyskajHaslo(string login, string email)
        {
            ...
            {
                // Nie wskazujemy, które dane są błędne (bezpieczeństwo)
        ...
        public IActionResult Login(string login, string password)
        {
            ...
            // po udanym logowaniu - zresetuj licznik i blokade
            userCheck.FailedLoginAttempts = 0;
            userCheck.LockoutEnd = null;
            _context.SaveChanges();

            // jeśli użytkownik musi zmienić hasło (po resecie) - przekieruj do ZmieniHaslo
        ...
        public IActionResult Edytuj(Uzytkownik model)
        {
            ...
            // sprawdzenie unikalności Email (jeśli się zmienił)
            ...
            // sprawdzenie unikalności PESEL (jeśli się zmienił)
        ...
        public IActionResult MuszZmieniHaslo(int id, string noweHaslo, string powtorzHaslo)
        {
            ...
            // wylogowanie z flagi wymuszenia
